...
export class DynamicReportDashboardComponent implements OnInit {
  ...
  widgetsList = {
    ...
    "Avg. Unloading Time Graph ": "avg-uloading-time",
    "Detention Trend": "detention-trend",
    "Worst 3 Consignee (1 Month)": "worst-consignee",
    "Worst 3 Consignee (6 Month)": "worst-consignee-months",
    "Worst Transporter (1 Month)": "worst-transporter",
    "Worst Transporter (6 Month)": "worst-transporter-months",
    "Maintainance Work Trends (Last 6 Months)": "maintainance-work-trend",
    "Vehicle with Maint. Delay (Most Aged)": "vehicle-maintainance-most-aged",
    "Vehicles in Maintainance (Max. Dur.)": "vehicle-maintainance-max-dur",
    "Vehicle With Highest Maintainance Cost (Last 90 Days)": "vehicle-maintainance-cost",
    "Vehicle With Highest Maintainance Count (Last 90 Days)": "vehicle-maintainance-count",
    "Top Workshops (Last 90 Days)": "top-workshop"
