...
@Component({
  selector: 'worst-loading-sites',
  templateUrl: './worst-loading-sites.component.html',
  styleUrls: ['./worst-loading-sites.component.scss']
})
export class WorstLoadingSitesComponent implements OnInit {
  loadingSlowest=[];
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("loading-3");
