...
@Component({
  selector: 'worst-parking-sites',
  templateUrl: './worst-parking-sites.component.html',
  styleUrls: ['./worst-parking-sites.component.scss']
})
export class WorstParkingSitesComponent implements OnInit {
  loadingSlowest = [];
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("loading-5");
