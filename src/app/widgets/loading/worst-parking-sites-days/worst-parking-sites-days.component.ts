...
@Component({
  selector: 'worst-parking-sites-days',
  templateUrl: './worst-parking-sites-days.component.html',
  styleUrls: ['./worst-parking-sites-days.component.scss']
})
export class WorstParkingSitesDaysComponent implements OnInit {
  loadingSlowest7days = [];
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("loading-6");
