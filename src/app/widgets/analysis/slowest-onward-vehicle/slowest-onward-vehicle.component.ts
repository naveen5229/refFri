...
@Component({
  selector: 'slowest-onward-vehicle',
  templateUrl: './slowest-onward-vehicle.component.html',
  styleUrls: ['./slowest-onward-vehicle.component.scss']
})
export class SlowestOnwardVehicleComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("liveload-7");
