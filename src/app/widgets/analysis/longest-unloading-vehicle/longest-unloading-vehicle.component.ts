...
@Component({
  selector: 'longest-unloading-vehicle',
  templateUrl: './longest-unloading-vehicle.component.html',
  styleUrls: ['./longest-unloading-vehicle.component.scss']
})
export class LongestUnloadingVehicleComponent implements OnInit {
