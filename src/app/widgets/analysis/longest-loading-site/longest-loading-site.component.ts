...
@Component({
  selector: 'longest-loading-site',
  templateUrl: './longest-loading-site.component.html',
  styleUrls: ['./longest-loading-site.component.scss']
})
export class LongestLoadingSiteComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("liveload-3");
