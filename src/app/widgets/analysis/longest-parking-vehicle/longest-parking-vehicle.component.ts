...
@Component({
  selector: 'longest-parking-vehicle',
  templateUrl: './longest-parking-vehicle.component.html',
  styleUrls: ['./longest-parking-vehicle.component.scss']
})
export class LongestParkingVehicleComponent implements OnInit {
  liveLongestParking =[];
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("liveload-5");
