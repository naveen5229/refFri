...
@Component({
  selector: 'longest-loading-sites',
  templateUrl: './longest-loading-sites.component.html',
  styleUrls: ['./longest-loading-sites.component.scss']
})
export class LongestLoadingSitesComponent implements OnInit {
