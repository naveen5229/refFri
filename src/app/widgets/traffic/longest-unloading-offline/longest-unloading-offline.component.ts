...
@Component({
  selector: 'longest-unloading-offline',
  templateUrl: './longest-unloading-offline.component.html',
  styleUrls: ['./longest-unloading-offline.component.scss']
})
export class LongestUnloadingOfflineComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("trafficload-6");
