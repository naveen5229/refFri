...
@Component({
  selector: 'longest-unloading-days',
  templateUrl: './longest-unloading-days.component.html',
  styleUrls: ['./longest-unloading-days.component.scss']
})
export class LongestUnloadingDaysComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("transportar-4");
