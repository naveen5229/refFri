...
@Component({
  selector: 'vehicle-maintainance-most-aged',
  templateUrl: './vehicle-maintainance-most-aged.component.html',
  styleUrls: ['./vehicle-maintainance-most-aged.component.scss']
})
export class VehicleMaintainanceMostAgedComponent implements OnInit {
  challansMostAged = [];
  chart2 = {
    type: '',
    data: {},
