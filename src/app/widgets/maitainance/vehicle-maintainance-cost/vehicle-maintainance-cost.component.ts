...
@Component({
  selector: 'vehicle-maintainance-cost',
  templateUrl: './vehicle-maintainance-cost.component.html',
  styleUrls: ['./vehicle-maintainance-cost.component.scss']
})
export class VehicleMaintainanceCostComponent implements OnInit {
  challanStateWise = [];
  chart2 = {
    type: '',
    data: {},
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("maintainance-3");
