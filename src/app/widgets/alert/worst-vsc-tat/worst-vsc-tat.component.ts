...
@Component({
  selector: 'worst-vsc-tat',
  templateUrl: './worst-vsc-tat.component.html',
  styleUrls: ['./worst-vsc-tat.component.scss']
})
export class WorstVscTatComponent implements OnInit {
  alertVscWorst =[];
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("alertload-9");
