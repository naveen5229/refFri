...
@Component({
  selector: 'worst-call-tat',
  templateUrl: './worst-call-tat.component.html',
  styleUrls: ['./worst-call-tat.component.scss']
})
export class WorstCallTatComponent implements OnInit {
  alertWorstCallTat =[];
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("alertload-8");
