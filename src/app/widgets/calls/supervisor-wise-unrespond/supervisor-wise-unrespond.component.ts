...
@Component({
  selector: 'supervisor-wise-unrespond',
  templateUrl: './supervisor-wise-unrespond.component.html',
  styleUrls: ['./supervisor-wise-unrespond.component.scss']
})
export class SupervisorWiseUnrespondComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    showLoader(index = 0) {
      setTimeout(() => {
        let outers = document.getElementsByClassName("callsload-5");
