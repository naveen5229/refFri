...
@Component({
  selector: 'worst-consignee',
  templateUrl: './worst-consignee.component.html',
  styleUrls: ['./worst-consignee.component.scss']
})
export class WorstConsigneeComponent implements OnInit {
