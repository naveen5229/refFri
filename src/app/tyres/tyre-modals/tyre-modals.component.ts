...
ngOnInit() {
  ...
  getModals() {
    ...
    this.api.get('Stock/getModals?' + params)
      .subscribe(res => {
        ...
        console.log("getTyreModals", this.selectedModal.id = this.modals[0].name, this.modals);
  ...
  getStockItems() {
    ...
    let params = "typeId=-1&stockSubTypeId=" + this.selectedModal.id;
    console.log("params ", params);
  ...
  openStockItemModal(stockitem?) {
    ...
    if (stockitem) {
      ...
      this.common.params = { stocktype_name: 'Tyre', stocktype_id: -1, stoctsubtypename: this.selectedModal.name, stocksubtype_id: this.selectedModal.id };
    }
  ...
  openStockSubTypeModal(stocksubType?) {
    if (stocksubType) {
      ...
      this.common.params = { stocktypename: "Tyre", stocktype_id: -1 };
    }
