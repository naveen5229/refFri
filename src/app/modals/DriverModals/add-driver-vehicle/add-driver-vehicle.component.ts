...
@Component({
  selector: 'add-driver-vehicle',
  templateUrl: './add-driver-vehicle.component.html',
  styleUrls: ['./add-driver-vehicle.component.scss']
})
export class AddDriverVehicleComponent implements OnInit {
...
ngOnInit() {
  ...
  addNewdriver() {
    if(this.dlTypes){
      ...
      dttime:this.common.dateFormatter(new Date(this.driver.dateofbirth)),
    ...
    this.common.loading++;
    this.api.post('Drivers/addDriverInfo', params)
      .subscribe(res => {
        this.common.loading--;
