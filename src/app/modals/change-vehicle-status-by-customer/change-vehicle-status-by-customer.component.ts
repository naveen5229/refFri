...
@Component({
  selector: 'change-vehicle-status-by-customer',
  templateUrl: './change-vehicle-status-by-customer.component.html',
  styleUrls: ['./change-vehicle-status-by-customer.component.scss']
})
export class ChangeVehicleStatusByCustomerComponent implements OnInit {
